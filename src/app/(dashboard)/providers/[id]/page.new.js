  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div>
        ...
        >
          <LucideIcon name="arrow_back" className="text-lg" />
          Back to Providers
        </Link>
        ...
        {connections.length === 0 ? (
          <div className="text-center py-12">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 text-primary mb-4">
              <LucideIcon name={isOAuth ? "lock" : "key"} className="text-[32px]" />
            </div>
...
function ModelRow({ model, fullModel, alias, selected, onToggleSelect, copied, onCopy }) {
  return (
    <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-border hover:bg-sidebar/50">
      ...
      >
        <LucideIcon name={selected ? "check_box" : "check_box_outline_blank"} className="text-[18px]" />
      </button>
      <LucideIcon name="smart_toy" className="text-base text-text-muted" />
    ...
    >
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div className="flex flex-col">
          ...
          >
            <LucideIcon name="keyboard_arrow_up" className="text-sm" />
          </button>
          <button
            onClick={onMoveDown}
            disabled={isLast}
          ...
          >
            <LucideIcon name="keyboard_arrow_down" className="text-sm" />
          </button>
        </div>
