...
for (const [file, errors] of byFile) {
  ...
  for (const code of codes) {
    ...
    switch (code) {
      case "TS7006":
        f = fixTS7006(file, codeErrors);
        break;
      case "TS7031":
        f = fixTS7031(file, codeErrors);
        break;
      case "TS7053":
        f = fixTS7053(file, codeErrors);
        break;
      case "TS7018":
        f = fixTS7018(file, codeErrors);
        break;
      case "TS7034":
        f = fixTS7034(file, codeErrors);
        break;
      case "TS7005":
        f = fixTS7005(file, codeErrors);
        break;
      case "TS7010":
        f = fixTS7010(file, codeErrors);
        break;
      case "TS7023":
        f = fixTS7023(file, codeErrors);
        break;
    }
    fileFixed += f;
    totalFixed += f;
